...
x_train_aug, x_val_aug, y_train_aug, y_val_aug = train_test_split(x_aug, y_aug, test_size=0.5, random_state=42)
print('Number of train data (after augmentation): ', x_train_aug.shape[0])
print('Number of validation data (after augmentation): ', x_val_aug.shape[0])
...
x_train_aug = minmaxscaler(x_train_aug)
x_test = minmaxscaler(x_test)
x_val_aug = minmaxscaler(x_val_aug)
# Plot the standardized spectra
plt.figure(figsize=(7, 5))
_ = plt.plot(wavelengths, x_train_aug[0:1].T)
...
def conv_1d_block(x, num_filters, filter_size, conv_stride):
    ...
    return x
def vgg_model(input_dim, output_dim,
                num_filters1, num_filters2, num_filters3, num_filters4, 
                num_filters5, num_filters6, num_filters7, num_filters8,
                filter_size1, filter_size2, filter_size3, filter_size4, 
                filter_size5, filter_size6, filter_size7, filter_size8,
                conv_stride1, conv_stride2, conv_stride3, conv_stride4, 
                conv_stride5, conv_stride6, conv_stride7, conv_stride8,
                pool_size1, pool_size2, pool_size3, pool_size4, pool_size5,
                pool_stride1, pool_stride2, pool_stride3, pool_stride4, pool_stride5,
                dense_units1, dense_units2,
                optimizer, 
                learning_rate):
    
    """ Define the architecture of the VGG-16 model """
    inputs = layers.Input(shape=(input_dim, 1))
    # Block 1
    conv1 = conv_1d_block(inputs, num_filters1, filter_size1, conv_stride1)
    pool1 = layers.MaxPooling1D(pool_size1, pool_stride1, padding='same')(conv1)
    # Block 2
    conv2 = conv_1d_block(pool1, num_filters2, filter_size2, conv_stride2)
    pool2 = layers.MaxPooling1D(pool_size2, pool_stride2, padding='same')(conv2)
    # Block 3
    conv3 = conv_1d_block(pool2, num_filters3, filter_size3, conv_stride3)
    conv4 = conv_1d_block(conv3, num_filters4, filter_size4, conv_stride4)
    pool3 = layers.MaxPooling1D(pool_size3, pool_stride3, padding='same')(conv4)
    # Block 4
    conv5 = conv_1d_block(pool3, num_filters5, filter_size5, conv_stride5)
    conv6 = conv_1d_block(conv5, num_filters6, filter_size6, conv_stride6)
    pool4 = layers.MaxPooling1D(pool_size4, pool_stride4, padding='same')(conv6)
    # Block 5
    conv7 = conv_1d_block(pool4, num_filters7, filter_size7, conv_stride7)
    conv8 = conv_1d_block(conv7, num_filters8, filter_size8, conv_stride8)
    pool5 = layers.MaxPooling1D(pool_size5, pool_stride5, padding='same')(conv8)
    
    # Fully connected layers
    flatten = layers.Flatten(name='flatten')(pool5)
    # Dense layer
    dense1 = layers.Dense(dense_units1, activation='relu')(flatten)
    dense2 = layers.Dense(dense_units2, activation='relu')(dense1)
    # Output layer
...
def vgg_bo(input_data, output_data,
             num_filters1, num_filters2, num_filters3, num_filters4, 
             num_filters5, num_filters6, num_filters7, num_filters8,
             filter_size1, filter_size2, filter_size3, filter_size4, 
             filter_size5, filter_size6, filter_size7, filter_size8,
    ...
    num_filters6 = int(num_filters6)
    num_filters7 = int(num_filters7)
    num_filters8 = int(num_filters8)
    ...
    filter_size6 = int(filter_size6)
    filter_size7 = int(filter_size7)
    filter_size8 = int(filter_size8)
    ...
    conv_stride6 = int(conv_stride6)
    conv_stride7 = int(conv_stride7)
    conv_stride8 = int(conv_stride8)
    pool_size1 = int(pool_size1)
    pool_size2 = int(pool_size2)
    pool_size3 = int(pool_size3)
    pool_size4 = int(pool_size4)
    pool_size5 = int(pool_size5)
    pool_stride1 = int(pool_stride1)
    pool_stride2 = int(pool_stride2)
    pool_stride3 = int(pool_stride3)
    pool_stride4 = int(pool_stride4)
    pool_stride5 = int(pool_stride5)
    ...
    """ Define the VGG-16 model for Bayesian Optimization """
    model = vgg_model(
        input_dim=input_dim, output_dim=output_dim,
        num_filters1=num_filters1, num_filters2=num_filters2, num_filters3=num_filters3,
        num_filters4=num_filters4, num_filters5=num_filters5, num_filters6=num_filters6,
        num_filters7=num_filters7, num_filters8=num_filters8,
        filter_size1=filter_size1, filter_size2=filter_size2, filter_size3=filter_size3, 
        filter_size4=filter_size4, filter_size5=filter_size5, filter_size6=filter_size6,
        filter_size7=filter_size7, filter_size8=filter_size8, 
        conv_stride1=conv_stride1, conv_stride2=conv_stride2, conv_stride3=conv_stride3,
        conv_stride4=conv_stride4, conv_stride5=conv_stride5, conv_stride6=conv_stride6, 
        conv_stride7=conv_stride7, conv_stride8=conv_stride8,
        pool_size1=pool_size1, pool_size2=pool_size2, pool_size3=pool_size3,
        pool_size4=pool_size4, pool_size5=pool_size5,
        pool_stride1=pool_stride1, pool_stride2=pool_stride2, pool_stride3=pool_stride3,
        pool_stride4=pool_stride4, pool_stride5=pool_stride5,
        dense_units1=dense_units1, dense_units2=dense_units2,
...
params_vgg = {
    'num_filters1': (1, 128),   # Number of filters in the first convolutional layer
    'num_filters2': (1, 128),   # Number of filters in the second convolutional layer
    'num_filters3': (1, 128),   # Number of filters in the second convolutional layer
    'num_filters4': (1, 128),   # Number of filters in the second convolutional layer
    'num_filters5': (1, 128),   # Number of filters in the second convolutional layer
    'num_filters6': (1, 128),   # Number of filters in the second convolutional layer
    'num_filters7': (1, 128),   # Number of filters in the second convolutional layer
    'num_filters8': (1, 128),   # Number of filters in the second convolutional layer
    ...
    'filter_size3': (1, 15),    # Size of the filter in the first convolutional layer
    'filter_size4': (1, 15),    # Size of the filter in the first convolutional layer
    'filter_size5': (1, 15),    # Size of the filter in the first convolutional layer
    'filter_size6': (1, 15),    # Size of the filter in the first convolutional layer
    'filter_size7': (1, 15),    # Size of the filter in the first convolutional layer
    'filter_size8': (1, 15),    # Size of the filter in the first convolutional layer
    'conv_stride1': (1, 5),     # Stride for the first convolutional layer
    'conv_stride2': (1, 5),     # Stride for the second convolutional layer
    'conv_stride3': (1, 5),     # Stride for the second convolutional layer
    'conv_stride4': (1, 5),     # Stride for the second convolutional layer
    'conv_stride5': (1, 5),     # Stride for the second convolutional layer
    'conv_stride6': (1, 5),     # Stride for the second convolutional layer
    'conv_stride7': (1, 5),     # Stride for the second convolutional layer
    'conv_stride8': (1, 5),     # Stride for the second convolutional layer
    'pool_size1': (1, 5),       # Pool size for the first pooling layer
    'pool_size2': (1, 5),       # Pool size for the second pooling layer
    'pool_size3': (1, 5),       # Pool size for the second pooling layer
    'pool_size4': (1, 5),       # Pool size for the second pooling layer
    'pool_size5': (1, 5),       # Pool size for the second pooling layer
    'pool_stride1': (1, 5),     # Stride for the first pooling layer
    'pool_stride2': (1, 5),     # Stride for the second pooling layer
    'pool_stride3': (1, 5),     # Stride for the second pooling layer
    'pool_stride4': (1, 5),     # Stride for the second pooling layer
    'pool_stride5': (1, 5),     # Stride for the second pooling layer
...
# Wrap vgg_bo so only hyperparameters are passed by the optimizer
vgg_bo_wrapper = lambda **params: vgg_bo(
    x_train, y_train,  # <-- your data
    **params
)
# Initialize Bayesian Optimization  
vgg_bo_optimizer = BayesianOptimization(
    f=vgg_bo_wrapper, 
    pbounds=params_vgg, 
    random_state=42
)
# Maximize the Bayesian Optimization function
vgg_bo_optimizer.maximize(
...
params_vgg_ = vgg_bo_optimizer.max['params']
# Print the best parameters found by Bayesian Optimization  
print("Best parameters found by Bayesian Optimization:")
for param, value in params_vgg_.items():
    print(f"{param}: {value}")

# Extract the best parameters
optimizerL = [Adam, SGD, RMSprop, Adagrad]  # List of optimizers
# Convert the best parameters to integers or floats as needed
num_filters1 = round(params_vgg_['num_filters1'])
num_filters2 = round(params_vgg_['num_filters2'])
num_filters3 = round(params_vgg_['num_filters3'])
num_filters4 = round(params_vgg_['num_filters4'])
num_filters5 = round(params_vgg_['num_filters5'])
num_filters6 = round(params_vgg_['num_filters6'])
num_filters7 = round(params_vgg_['num_filters7'])
num_filters8 = round(params_vgg_['num_filters8'])
filter_size1 = round(params_vgg_['filter_size1'])
filter_size2 = round(params_vgg_['filter_size2'])
filter_size3 = round(params_vgg_['filter_size3'])
filter_size4 = round(params_vgg_['filter_size4'])
filter_size5 = round(params_vgg_['filter_size5'])
filter_size6 = round(params_vgg_['filter_size6'])
filter_size7 = round(params_vgg_['filter_size7'])
filter_size8 = round(params_vgg_['filter_size8'])
conv_stride1 = round(params_vgg_['conv_stride1'])
conv_stride2 = round(params_vgg_['conv_stride2'])
conv_stride3 = round(params_vgg_['conv_stride3'])
conv_stride4 = round(params_vgg_['conv_stride4'])
conv_stride5 = round(params_vgg_['conv_stride5'])
conv_stride6 = round(params_vgg_['conv_stride6'])
conv_stride7 = round(params_vgg_['conv_stride7'])
conv_stride8 = round(params_vgg_['conv_stride8'])
pool_size1 = round(params_vgg_['pool_size1'])
pool_size2 = round(params_vgg_['pool_size2'])
pool_size3 = round(params_vgg_['pool_size3'])
pool_size4 = round(params_vgg_['pool_size4'])
pool_size5 = round(params_vgg_['pool_size5'])
pool_stride1 = round(params_vgg_['pool_stride1'])
pool_stride2 = round(params_vgg_['pool_stride2'])
pool_stride3 = round(params_vgg_['pool_stride3'])
pool_stride4 = round(params_vgg_['pool_stride4'])
pool_stride5 = round(params_vgg_['pool_stride5'])
dense_units1 = round(params_vgg_['dense_units1'])
dense_units2 = round(params_vgg_['dense_units2'])
learning_rate = params_vgg_['learning_rate']
batch_size = round(params_vgg_['batch_size'])
optimizer = optimizerL[round(params_vgg_['optimizer'])]
...
print(f"num_filters6: {num_filters6}")
print(f"num_filters7: {num_filters7}")
print(f"num_filters8: {num_filters8}")
...
print(f"filter_size6: {filter_size6}")
print(f"filter_size7: {filter_size7}")
print(f"filter_size8: {filter_size8}")
...
print(f"conv_stride6: {conv_stride6}")
print(f"conv_stride7: {conv_stride7}")
print(f"conv_stride8: {conv_stride8}")

print(f"pool_size1: {pool_size1}")
print(f"pool_size2: {pool_size2}")
print(f"pool_size3: {pool_size3}")
print(f"pool_size4: {pool_size4}")
print(f"pool_size5: {pool_size5}")

print(f"pool_stride1: {pool_stride1}")
print(f"pool_stride2: {pool_stride2}")
print(f"pool_stride3: {pool_stride3}")
print(f"pool_stride4: {pool_stride4}")
print(f"pool_stride5: {pool_stride5}")
...
best_params = pd.DataFrame({
    ...
    'num_filters6': [num_filters6],
    'num_filters7': [num_filters7],
    'num_filters8': [num_filters8],
    ...
    'filter_size6': [filter_size6],
    'filter_size7': [filter_size7],
    'filter_size8': [filter_size8],
    ...
    'conv_stride6': [conv_stride6],
    'conv_stride7': [conv_stride7],
    'conv_stride8': [conv_stride8],
    ...
    'pool_stride4': [pool_stride4],
    'pool_stride5': [pool_stride5],
...
vgg_best_model = vgg_model(
    input_dim=x_train_aug.shape[1],
    output_dim=y_train_aug.shape[1],
    num_filters1=num_filters1, num_filters2=num_filters2,
    num_filters3=num_filters3, num_filters4=num_filters4,
    num_filters5=num_filters5, num_filters6=num_filters6,
    num_filters7=num_filters7, num_filters8=num_filters8,
    filter_size1=filter_size1, filter_size2=filter_size2,
    filter_size3=filter_size3, filter_size4=filter_size4,
    filter_size5=filter_size5, filter_size6=filter_size6,
    filter_size7=filter_size7, filter_size8=filter_size8,
    conv_stride1=conv_stride1, conv_stride2=conv_stride2,
    conv_stride3=conv_stride3, conv_stride4=conv_stride4,
    conv_stride5=conv_stride5, conv_stride6=conv_stride6,
    conv_stride7=conv_stride7, conv_stride8=conv_stride8,
    pool_size1=pool_size1, pool_size2=pool_size2,
    pool_size3=pool_size3, pool_size4=pool_size4,
    pool_size5=pool_size5, 
    pool_stride1=pool_stride1, pool_stride2=pool_stride2,
    pool_stride3=pool_stride3, pool_stride4=pool_stride4,
    pool_stride5=pool_stride5,
    dense_units1=dense_units1, dense_units2=dense_units2,
    optimizer=optimizer, learning_rate=learning_rate,
)
...
vgg_best_model.save(f'{output_path}{model_name}_best_model.keras')
vgg_best_model.save_weights(f'{output_path}{model_name}_best_model.model.weights.h5')

# Print the model summary
vgg_best_model.summary()
...
scores = vgg_best_model.evaluate(x_val_aug, y_val_aug, verbose=0)
print("%s: %.2f%%" % (vgg_best_model.metrics_names[1], scores[1]*100))
...
y_pred = vgg_best_model.predict(x_test)
